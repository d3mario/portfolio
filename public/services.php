...
<button id=\"nextButton\" rel=\"js-case-study-right-button\" /> </button> ";
		...
		echo "<p><a rel='servicesProvided' href=\"#servicesProvided\" ?page=\"".$row['id']."\" rel=\"group1\">Skilled <span class=\"samples-text\">"."Technolgies"."</span></a> 
		
		<a rel='viewLargeDisplay02' href=\"#viewLargeDisplay02\">View<span class=\"samples-text\">"."Resume"."</span></a>
...
//		echo "</ul>";
	...
	<div id="modal" rel="js-modal">
		<?php
		echo '<img class="modal-image" src="documents/'.$print_large_views[0].'" alt="'.$row['view-01-alt-description'].'"rel="largeModalImage'.'" >';
		?>
	</div>
	...
	<div id="servicesDisplay" rel="js-service-modal">
		<div class="modal-content">
			<div id="lb" rel="js-service-modal">
				<p id="services-heading"> Technolgies &amp; Software:</p>
			</div>
			...
			if (0 < $page && $page != ''  )
			{
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					for ( $i = 0; $i < $languages_results; $i++ )
					{
						...
						echo "<td> <div class=\"progressBar\" id=\"max $print_percentage[$i]\"><div></div></div></td>";
